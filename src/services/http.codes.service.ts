...
export const HTTP_CODES: httpCodesInterface[] = [
    ...
    { code: HttpStatusCode.Processing, message: "No hay ninguna conexión establecida", class: "class_alert_warning" },
    ...
    { code: HttpStatusCode.InternalServerError, message: "Ocurrió un error en el servidor, inténtalo más tarde", class: "class_alert_warning" },
]